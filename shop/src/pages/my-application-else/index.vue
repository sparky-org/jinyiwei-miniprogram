<template>
  <div class="page">
    ...
    <div class="weui-cells weui-cells_after-title">
      <div class="weui-cell weui-cell_input">
        ...
        <div class="weui-cell__bd" style="padding: 20rpx 0;">
           <textarea placeholder="请输入申请内容" v-model="content" style="height: 3.3em; width: 100%;" />
        </div>
      </div>
    </div>
    ...
    <div class="page__bd">
      <div class="weui-cells no-t" style="margin-top: 0; border-top: 0 none; margin-top: -1rpx;">
        <div class="weui-cell">
          <div class="weui-cell__bd">
            <div class="weui-uploader">
              <div class="weui-uploader__hd">
...
export default {
  ...
  methods: {
    ...
    async handleSubmit(){
      console.info(this.content,this.spData.length)
      if(!this.content || !this.spData.length){
