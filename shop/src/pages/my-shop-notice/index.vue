    ...
    <div class="weui-cells weui-cells_after-title no-t-b">
      <div class="weui-cell">
        <div class="weui-cell__bd">
          <textarea :disabled="!canEdit" maxlength="1000" :auto-height="true" :placeholder="canEdit?'请输入公告':''" style="min-height: 9.9em; width: 100%; font-size: 16px;" v-model="noticeText" />
