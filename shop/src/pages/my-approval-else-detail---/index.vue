      ...
      <div class="weui-cells weui-cells_after-title no-t">
        <div class="weui-cell weui-cell_input">
          <div class="weui-cell__hd">
            <div class="weui-label"><span class="required">*</span>申请标题</div>
          </div>
        ...
        <div class="weui-cell weui-cell_input">
          <div class="weui-cell__hd">
            <div class="weui-label"><span class="required">*</span>任务名称</div>
          </div>
          <div class="weui-cell__bd">
            <input class="weui-input" placeholder="" value="1" />
          </div>
        </div>
        ...
        <div class="weui-cell weui-cell_input">
          ...
          <div class="weui-cell__bd">
            <input class="weui-input" placeholder="" value="李德华" />
          </div>
        </div>
        ...
        <div class="weui-cell weui-cell_input">
          ...
          <div class="weui-cell__bd">
            <input class="weui-input" placeholder="" value="30" />
          </div>
        </div>
        ...
        <div class="weui-cells weui-cells_after-title">
          <div class="weui-cell weui-cell_input">
            <div class="weui-cell__hd">
              <div class="weui-label"><span class="required">*</span>审批备注</div>
            </div>
            <div class="weui-cell__bd" style="padding: 20rpx 0;">
              <textarea class="" placeholder="" style="height: 3.3em; width: 100%;" v-model="noticeText" />
            </div>
          </div>
        </div>
    ...
    <!-- <div class="operate-btn">
      <div class="weui-flex">
        <div class="weui-flex__item" style="padding-right: 10rpx;">
          <button class="weui-btn" type="warn" @click="handleAdd">拒 绝</button>
        </div>
        <div class="weui-flex__item" style="padding-left: 10rpx;">
          <button class="weui-btn" type="primary" @click="handleAdd">同 意</button>
        </div>
      </div>
    </div> -->

    <div class="operate-btn">
      <button class="weui-btn" type="default" disabled="disabled" style="border: 1rpx solid #d9d9d9;">已通过</button>
    </div>
