  ...
  <div class="page">
    <div v-if="add">
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell weui-cell_input">
          ...
          <div class="weui-cell__bd">
            <input class="weui-input" placeholder="请输入要创建的项目" />
          </div>
        </div>
        ...
        <div class="weui-cell weui-cell_input">
          ...
          <div class="weui-cell__bd">
            <input class="weui-input" placeholder="请输入护理时长" />
          </div>
        </div>
        ...
        <div class="weui-cell weui-cell_input">
          ...
          <div class="weui-cell__bd">
            <input class="weui-input" placeholder="请输入完成奖励积分" />
          </div>
        </div>
      </div>
      ...
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell">
          <div class="weui-cell__bd">
            <textarea class="" placeholder="请输入项目描述" style="height: 9.9em; width: 100%;" />
          ...
          <view class='content' @click='showDetail' :data-index="index">
            <view class='column'>
              ...
              <view class='item-text'>
                <view>{{item.name}}</view>
                <view>时间:{{item.createDate}}分钟</view>
              </view>
    ...
    <div class="operate-btn">
      ...
      <button class="weui-btn" type="primary" @click="handleAdd" v-if="add">创建项目</button>
    </div>
  </div>
</template>
