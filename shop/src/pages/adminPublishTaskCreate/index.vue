<template>
  <div class="publish_task_create">
    <template v-if="!checkStaff">
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell weui-cell_input">
          ...
          <div class="weui-cell__bd">
            <input class="weui-input" v-model="form.taskName" placeholder="请输入任务名称" />
          </div>
        </div>
        <div class="weui-cell weui-cell_input">
          <div class="weui-cell__hd">
          ...
          <!-- <div class="weui-cell__bd">
            <input class="weui-input"  v-model="form.targetType" placeholder="请输入面向对象" />
          </div> -->
      ...
      <div class="sureBth">
        <button class="weui-btn" type="primary" @click="handlePublish">确认发布</button>
      </div>
    </template>
    <template v-else>
      <div class="weui-cells weui-cells_after-title">
